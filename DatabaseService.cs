...
<<<<<<< HEAD
                    command.CommandText = @"
						CREATE TABLE IF NOT EXISTS Macros (
							...
							Description TEXT NOT NULL  -- Бывший CombinationType
						)";
...
>>>>>>> fff53c6
		...
		public List<Macro> GetMacros()
		{
			...
			using (var connection = new SqliteConnection(connectionString))
			{
				...
				var command = connection.CreateCommand();
<<<<<<< HEAD
                command.CommandText = "SELECT Id, KeyName, KeyCombination, Description FROM Macros";
...
<<<<<<< HEAD
							KeyCombination = reader.GetString(1),
